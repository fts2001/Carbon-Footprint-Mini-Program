export default {
  ...
  exportQuestion: [
    ...
    },
    {
      ...
      answer: ["我相信这个小程序的功能需要定位信息", "我觉得这个数据用途合理，目的是环保", "我习惯于授予类似权限，觉得没什么问题", "我认为自己可以随时关闭定位，不担心"],
      otherAnswer: "其他（请注明）",
      showFlag: "location_1"
    },
    {
    ...
    {
      question: "4.	公安部、国家互联网信息办公室等六部门联合公布《国家网络身份认证公共服务管理办法》帮助您获取网络身份认证，实现数据共享。您如果需要可通过下载国家网络身份认证APP领取（见此文https://www.cac.gov.cn/2025-05/23/c_1749711107835487.htm）。该认证可为公民提供可信的数字身份认证服务。您听说过这个认证吗？",
      answer: ["听说过", "没听说", "不好说", "不想回答"]
    },
    {
      question: "5.	利用该数字身份认证在不同部门之间共享公民个人数据（如行政检查、公安、税务）有助于提升效率，但也可能涉及公民的个人隐私。对以下观点您最赞同的是",
      answer: ["我支持有关部门共享数据，这样可以避免数据管理混乱带来的个人网络隐私信息风险", "在确保个人信息脱敏后，在各部门之间共享数据以提高公共服务效率", "如果明确在共享前完全删除身份证号、手机号等敏感信息，我愿意提供数据支持此类共享", "所有数据均需用户单独授权后才能共享","即使数据被脱敏，我还是担心部门间共享我的个人信息可能会被滥用","	比起公共服务以外的目的，我更担心有关部门不当收集隐私信息","不知道或者说不清"]
    }
  ],
  colorStyle: null,
  background: null,
